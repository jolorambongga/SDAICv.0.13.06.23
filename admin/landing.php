            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-check mb-3">
                  <input class="form-check-input" type="radio" name="about_us_image_option" id="about_us_image_url" value="url">
                  <label class="form-check-label" for="about_us_image_url">
                    URL
                  </label>
                </div>
                <div class="form-check mb-3">
                  <input class="form-check-input" type="radio" name="about_us_image_option" id="about_us_image_upload" value="upload">
                  <label class="form-check-label" for="about_us_image_upload">
                    Upload Image
                  </label>
                </div>
                <div class="input-group mb-3 about-us-image-url" style="display: none;">
                  <input type="url" class="form-control" id="about_us_image_url_input" placeholder="Enter URL">
                </div>
                <div class="input-group mb-3 about-us-image-upload" style="display: none;">
                  <input type="file" class="form-control" id="about_us_image_upload_input">
                </div>
                <pre></pre>
                ...
                <div class="form-check mb-3">
                  <input class="form-check-input" type="radio" name="main_image_option" id="main_image_url" value="url">
                  <label class="form-check-label" for="main_image_url">
                    URL
                  </label>
                </div>
                <div class="form-check mb-3">
                  <input class="form-check-input" type="radio" name="main_image_option" id="main_image_upload" value="upload">
                  <label class="form-check-label" for="main_image_upload">
                    Upload Image
                  </label>
                </div>
                <div class="input-group mb-3 main-image-url" style="display: none;">
                  <input type="url" class="form-control" id="main_image_url_input" placeholder="Enter URL">
                </div>
                <div class="input-group mb-3 main-image-upload" style="display: none;">
                  <input type="file" class="form-control" id="main_image_upload_input">
                </div>
                <pre></pre>
